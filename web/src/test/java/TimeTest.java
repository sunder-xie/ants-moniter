...
//        long before = d1.getTime();
    ...
    public void testHour() throws ParseException {
        SimpleDateFormat df = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");
        Date now = df.parse("2012-11-05 00:21:00");
        Date lastHourDate = TimeUtil.getBeforHourByNumber(now, -1);
        String lastHourDay = TimeUtil.getDateString(lastHourDate);
    ...
    public void testCompare() throws ParseException {
        String time1 = "2012-11-05 02:21:20";
        String time2 = "2012-11-05 02:21:00";

        System.out.println(TimeUtil.compareTime(time1,time2));
    }
}
