...
import com.ants.monitor.biz.support.processor.MonitorConstantsProcessor;
...
public class CommonTaskController {
    ...
    @Autowired
    private MonitorConstantsProcessor monitorConstantsProcessor;
    @Autowired
    ...
    private class AppConsumerOnDayProcess implements Runnable {
        ...
        public void run() {
            try {
                //每天更新ecs
                monitorConstantsProcessor.setValueToContants();
                //每天删除 大于15天的日期的原始数据
